            ...
            {trending.map((each, index) => (
              ...
              >
                <div className="flex flex-wrap">
                  <span className="font-bold font-mukta text-primary rounded-full h-12 w-12 flex justify-center bg-gray-300 items-center text-3xl">
                    {index + 1}.
                </span>
                  <div className="flex-1 pl-6">
                    <h3 className="no-underline hover:text-secondary text-xl font-mukta block text-gray-700 font-bold md:font-normal leading-normal">
                      {each.title}
                    </h3>
                  </div>
                </div>
