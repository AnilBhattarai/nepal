            ...
            <div className="container mx-auto">
              ...
              >
                <div key={_id} className="">
                  <h1 className="max-w-6xl mx-auto text-center text-4xl md:text-6xl px-5 md:px-10 pt-10 md:pt-20 hover:text-secondary font-mukta leading-tight font-bold md:font-normal">
                    {title}
                  </h1>
