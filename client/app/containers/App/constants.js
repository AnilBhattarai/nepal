...
export const FB_APP_ID = '403635297248992';
export const FB_APP_FIELDS = 'id,email,name';
export const RECAPTCHA_SITE_KEY = '6LcSQ78UAAAAAFlkl1dCE5T5l8rN4kQnYYNAP0Jc';
export const GOOGLE_CLIENT_ID =
  '521974798939-t17tkpgbfnjtg9o3ca7eldahs3401g5c.apps.googleusercontent.com';
...
export const IMAGE_BASE =
  process.env.NODE_ENV === 'production' ? '/' : 'http://localhost:5200/';

export const URL_BASE =
  process.env.NODE_ENV === 'production'
    ? 'https://new.nepalhomes.com/'
    : 'http://localhost:5200/';
...
export const SET_USER_NAME = 'app/App/SET_USER_NAME';
