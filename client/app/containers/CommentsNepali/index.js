...
export const Comments = props => {
  ...
  return commentLoading ? (
    <div>Loading....</div>
      ...
      <div className="mt-16">
        <h2 className="font-bold mb-2 text-2xl md:text-4xl font-mukta text-primary hide-mobile">
          प्रतिक्रिया
        ...
        {user && user.id ? (
          <div className="relative hide-mobile">
            ...
            <div
              className="mt-4 py-2 flex  ease-in-out cursor-pointer loginlink hide-mobile"
              onClick={redirectToLogin}
            >
              प्रतिक्रियाका लागी लगिन गर्नुस
            </div>
          )}
