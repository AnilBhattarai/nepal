...
class AddEdit extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    if (this.props.slug_url) {
      this.props.loadOneRequest(this.props.slug_url);
    }
    this.props.loadCategoryRequest();
    this.props.loadUsersRequest();
    this.props.setOneValue({ key: 'author', value: this.props.currentUser.id });
  }
  ...
  render() {
    ...
    return loading && loading == true ? (
      ...
      <React.Fragment>
        <Helmet>
          <title>{slug_url ? 'Edit Blog' : 'Add Blog'}</title>
        </Helmet>
        ...
        <PageContent>
          ...
          <div className="w-full md:w-1/2 pb-4">
            <label
              className="block uppercase tracking-wide text-gray-800 text-sm mb-2"
            ...
            <Select
              ...
              renderValue={selected => this.handleSelectedValue(selected, cats)}
            >
              {category.map(each => (
                <MenuItem key={each._id} value={each._id}>
                  {/* <Checkbox color="primary" checked={one.category.indexOf(each._id) > -1} /> */}
                  <Checkbox
                    color="primary"
                    checked={one.category.indexOf(each._id) > -1}
                  />
                  {each.title}
                </MenuItem>
              ))}
          ...
          <div className="pb-4">
            <label className="block uppercase tracking-wide text-gray-800 text-sm mb-2">
              Blog Description
            </label>
            <CKEditor
              name="description"
          ...
          <div className="w-full md:w-1/2 pb-4">
            ...
            <form onSubmit={this.insertMetaTags}>
              <input
                ...
                placeholder="press enter after each meta tag"
              />
            </form>
            <Paper>
          ...
          <div className="w-full md:w-1/2 pb-4">
            ...
            <form onSubmit={this.insertMetaKeywords}>
              <input
                ...
                placeholder="press enter after eachkeyboard"
              />
            </form>
            <Paper>
