...
export const loadTotalRequest = payload => ({
  type: types.LOAD_TOTAL_REQUEST,
  payload,
});
export const loadTotalSuccess = payload => ({
  type: types.LOAD_TOTAL_SUCCESS,
  payload,
});
export const loadTotalFailure = payload => ({
  type: types.LOAD_TOTAL_FAILURE,
  payload,
});
