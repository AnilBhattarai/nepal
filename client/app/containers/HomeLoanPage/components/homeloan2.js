    ...
    <>
      <div className="bg-blue-50">
        <div class="container mx-auto">
          <div className="bg-blue-50 py-16 px-4 lg:px-12 my-8">
            <div className="lg:flex">
              <div className="lg:w-3/5 lg:pr-20">
                ...
                <div className="flex items-center mt-6">
                  ...
                  {showChart && (
                    <p className="text-lg flex-1 pl-6">
                      Installment Rate :{' '}
              ...
              {showChart && (
                <div className="lg:w-2/5">
                  ...
                  <div className="flex items-center mt-5">
                    ...
                    <p className="flex-1 text-secondary">Principal Amount</p>
                  ...
                  <div className="flex items-center mt-5">
                    <span className="w-8 h-8 bg-teal-100 rounded-full" />
                    <p className="flex-1 text-secondary">Total Interest</p>
                    <span className="font-bold text-secondary text-xl">
