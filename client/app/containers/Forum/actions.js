...
export const setForumData = payload => ({
  type: types.SET_FORUM_DATA,
  payload,
});
...
export const loadMyRequest = payload => ({
  type: types.LOAD_MY_REQUEST,
  payload,
});
export const loadMySuccess = payload => ({
  type: types.LOAD_MY_SUCCESS,
  payload,
});
export const loadMyFailure = payload => ({
  type: types.LOAD_MY_FAILURE,
  payload,
});
