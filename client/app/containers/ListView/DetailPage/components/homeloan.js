  ...
  return (
    <>
      <div class="container mx-auto">
        <h2 className="text-2xl md:text-4xl text-black mt-16">
          Thinking about home loan ?
        </h2>
        <div className="bg-primary py-16 px-4 lg:px-12 mt-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10">
                ...
                <div>
                  <input
                    ...
                    onKeyPress={handleKeyPress}
                  />
                  <span className="absolute z-10 text-white p-4 bg-opacity-40  bg-white">
                    Yrs
                  </span>
                </div>
                <div>
