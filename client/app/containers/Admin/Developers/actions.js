...
export const setTempImageValue = payload => ({
  type: types.SET_TEMP_IMAGE_VALUE,
  payload,
});
export const setTempBannerValue = payload => ({
  type: types.SET_TEMP_BANNER_VALUE,
  payload,
});
...
export const setTempPhone = payload => ({
  type: types.SET_TEMP_PHONE_VALUE,
  payload,
});
export const setTempEmail = payload => ({
  type: types.SET_TEMP_EMAIL_VALUE,
  payload,
});
