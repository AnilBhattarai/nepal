...
export const loadAppliedUsersRequest = payload => ({
  type: types.LOAD_APPLIED_USERS_REQUEST,
  payload,
});
export const loadAppliedUsersSuccess = payload => ({
  type: types.LOAD_APPLIED_USERS_SUCCESS,
  payload,
});
export const loadAppliedUsersFailure = payload => ({
  type: types.LOAD_APPLIED_USERS_FAILURE,
  payload,
});
