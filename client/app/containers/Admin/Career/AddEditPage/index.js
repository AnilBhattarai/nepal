        ...
        <PageContent>
          ...
          <div className="w-full md:w-1/2 pb-4">
            ...
            <input
              ...
              id="grid-title"
              type="number"
              value={one.no_of_vacancy}
              onChange={handleChange('no_of_vacancy')}
            />
            <div id="component-error-text">{errors.no_of_vacancy}</div>
          </div>
          <div className="w-full md:w-1/2 pb-4">
            <label
              className="block uppercase tracking-wide text-grey-darker text-xs mb-2"
            ...
            <input
              ...
              id="grid-value"
              type="text"
              value={one.job_descriptions}
              onChange={handleChange('job_descriptions')}
            />
            <div id="component-error-text">{errors.job_descriptions}</div>
          </div>
          ...
          <div className="w-full md:w-1/2 pb-4">
            ...
            <input
              ...
              id="grid-value"
              type="date"
              value={one.deadline_at}
              onChange={handleChange('deadline_at')}
            />
            <div id="component-error-text">{errors.deadline_at}</div>
          </div>
          ...
          <div className="w-full md:w-1/2 pb-4">
            ...
            <input
              ...
              id="grid-description"
              type="text"
              value={one.skill_requirements}
              onChange={handleChange('skill_requirements')}
            />
            <div id="component-error-text">{errors.skill_requirements}</div>
          </div>
