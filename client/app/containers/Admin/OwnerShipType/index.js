...
export const OwnerShipType = props => {
  const {
  ...
  const handleAdd = () => {
    clearOne();
    push('/admin/ownership-type-manage/add');
  };

  const handleEdit = id => {
    push(`/admin/ownership-type-manage/edit/${id}`);
  };
  ...
  return (
    <>
      <Helmet>
        <title>OwnerShip Type Manage</title>
      </Helmet>
      <DeleteDialog
        open={open}
        doClose={handleClose}
      ...
      <div className="flex justify-between mt-3 mb-3">
        ...
        <PageHeader>OwnerShip Type </PageHeader>
        <Fab
          color="primary"
          aria-label="Add"
