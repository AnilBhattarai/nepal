...
export const PropertySection = props => {
  ...
  const handleAdd = () => {
    clearOne();
    push('/admin/property-section/add');
  };

  const handleEdit = id => {
    push(`/admin/property-section/edit/${id}`);
  };
  ...
  return (
    <>
      ...
      <div className="flex justify-between mt-3 mb-3">
        ...
        <PageHeader>Property Section Manage</PageHeader>
        {/* <Fab
          color="primary"
          aria-label="Add"
      ...
      <PageContent loading={loading}>
        ...
        <Table
          tableHead={['Property Section', 'Section Key', 'Action']}
          tableData={tableData}
