...
const propertySectionReducer = (state = initialState, action) =>
  produce(state, draft => {
    switch (action.type) {
      ...
      case types.SET_PROPERTIES_VALUE:
        draft.tempProperties = action.payload;
        break;
      ...
      case types.LOAD_PROPERTY_SUCCESS:
        draft.one.properties = [
          ...state.one.properties,
          {
      ...
      case types.SET_START_DATE:
        draft.one.properties[action.payload.index].start_date =
          action.payload.value;
        break;
      case types.SET_END_DATE:
        draft.one.properties[action.payload.index].end_date =
          action.payload.value;
        break;
    }
  });

export default propertySectionReducer;
