...
function* loadOne(action) {
  ...
  yield call(
    Api.get(
      `enum/listing_package/${action.payload}`,
...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/listing-package-manage'));
}
...
export default function* listingPackageSaga() {
