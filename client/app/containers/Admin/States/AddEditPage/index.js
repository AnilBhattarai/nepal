          ...
          <PageContent>
            <div className="w-full md:w-1/2 pb-4">
              ...
              <input
                ...
                id="grid-title"
                type="text"
                value={one.state_name}
                onChange={handleChange('state_name')}
              />
              <div id="component-error-text">{errors.state_name}</div>
            </div>
            <div className="w-full md:w-1/2 pb-4">
              <label
                className="block uppercase tracking-wide text-grey-darker text-xs mb-2"
...
const withReducer = injectReducer({ key: 'states', reducer });
const withSaga = injectSaga({ key: 'states', saga });
