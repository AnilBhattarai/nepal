...
export const States = props => {
  ...
  const handleAdd = () => {
    clearOne();
    push('/admin/states/add');
  };

  const handleEdit = id => {
    push(`/admin/states/edit/${id}`);
  };
  ...
  const tableData = data.map(({ _id, stateID, description, state_name }) => [
    stateID,
    state_name,
    description,
    <>
  ...
  return (
    <>
      ...
      <PageContent loading={loading}>
        ...
        <Table
          // tableHead={['Title', 'Value', 'Description']}
          tableHead={['State ID', 'State Name', 'Description', 'Action', '']}
          tableData={tableData}
