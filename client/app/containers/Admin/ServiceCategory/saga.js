...
function* loadOne(action) {
  ...
  yield call(
    Api.get(
      `enum/service_category/${action.payload}`,
...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/service-category-manage'));
}
...
export default function* serviceCategorySaga() {
