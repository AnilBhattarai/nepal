...
export const loadAgencyRequest = payload => ({
  type: types.LOAD_AGENY_REQUEST,
  payload,
});
export const loadAgencySuccess = payload => ({
  type: types.LOAD_AGENY_SUCCESS,
  payload,
});
export const loadAgencyFailure = payload => ({
  type: types.LOAD_AGENY_FAILURE,
  payload,
});

export const loadAgentByAgencyRequest = payload => ({
  type: types.LOAD_AGENT_BY_AGENCY_REQUEST,
  payload,
});
export const loadAgentByAgencySuccess = payload => ({
  type: types.LOAD_AGENT_BY_AGENCY_SUCCESS,
  payload,
});
export const loadAgentByAgencyFailure = payload => ({
  type: types.LOAD_AGENT_BY_AGENCY_FAILURE,
  payload,
});

export const AssignAgentRequest = payload => ({
  type: types.ASSIGN_AGENT_REQUEST,
  payload,
});
export const AssignAgentSuccess = payload => ({
  type: types.ASSIGN_AGENT_SUCCESS,
  payload,
});
export const AssignAgentFailure = payload => ({
  type: types.ASSIGN_AGENT_FAILURE,
  payload,
});
