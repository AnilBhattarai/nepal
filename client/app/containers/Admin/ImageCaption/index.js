...
export const ImageCaption = props => {
  ...
  const handleAdd = () => {
    clearOne();
    push('/admin/image-caption/add');
  };

  const handleEdit = id => {
    push(`/admin/image-caption/edit/${id}`);
  };
  ...
  return (
    <>
     <Helmet>
        <title>Image Caption Manage</title>
      </Helmet>
      <DeleteDialog
        open={open}
        doClose={handleClose}
      ...
      <div className="flex justify-between mt-3 mb-3">
        ...
        <PageHeader>Image Caption Manage </PageHeader>
        <Fab
          color="primary"
          aria-label="Add"
