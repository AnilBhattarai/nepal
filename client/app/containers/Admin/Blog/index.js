    ...
    return (
      <>
        <DeleteDialog
          ...
          doDelete={() => this.handleDeleteNews(this.state.deleteId)}
        />
        <Helmet>
        ...
        <div className="bg-white rounded p-2 mb-4">
          <div className="flex -mx-1 items-center">
            ...
            <div className="px-1 w-1/6">
              ...
              <div>
                <button
                  aria-label="Search"
                  className="bg-secondary mt-6 px-4 py-2 font-lg block text-white text-center w-full rounded leading-tighter "
          ...
          <button
            aria-label="Search"
            className="pt-2 inline-block text-secondary text-center underline"
