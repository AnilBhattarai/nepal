...
export const Area = props => {
  ...
  const handleEdit = id => {
    push(`/admin/area-manage/edit/${id}`);
  };
  ...
  const tableData = data.map(
    ({
      ...
      vdcmunicipality_id: { name: vdc_name },
    }) => [
      state_name,
      district_name,
      vdc_name,
  ...
  return (
    <>
      ...
      <div className="flex justify-between mt-3 mb-3">
        ...
        <PageHeader>Area Manage</PageHeader>
        {/* <Fab
          color="primary"
          aria-label="Add"
           ...
           >
             State
              ...
              <select
                ...
                // name="stateID"
                // value={query.stateID}
                disabled={!query.district_id}
                onChange={handleChange('np_vdcmunicipality')}
...
Area.propTypes = {
  ...
  loadVdcRequest: PropTypes.func.isRequired,
