...
export class ViewComment extends React.PureComponent {
  static propTypes = {
    ...
    loadManageRequest: PropTypes.func.isRequired,
  ...
  handleSelectChange = event => {
    // event.persist();
    this.props.setStatusValue(event.target.value);
  };
        ...
        <PageContent>
          <div className="bg-white mt-2 shadow p-2">
            <div className="print-fluid">
              ...
              {/* here, newly added status-dropdown to select the status of a comment */}
              <div className="w-full md:w-1/5 pb-4">
                ...
                >
                  ...
                  {this.props.status &&
                    ...
                    this.props.status.map((each, index) => (
