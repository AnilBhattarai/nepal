...
export const State = props => {
  ...
  const handleEdit = id => {
    push(`/admin/state-manage/edit/${id}`);
  };
  ...
  const tableData = data.map(({ _id, name, is_active }) => [
    name,
    <>
      <ToggleButton
        id={_id}
  ...
  return (
    <>
      <Helmet>
        <title>State Manage</title>
      </Helmet>
      <DeleteDialog
        msg="This will delete districts, vdc and area within this state!"
        open={open}
        doClose={handleClose}
      ...
      <div className="flex justify-between mt-3 mb-3">
        ...
        <PageHeader>State Manage</PageHeader>
        {/* <Fab
          color="primary"
          aria-label="Add"
