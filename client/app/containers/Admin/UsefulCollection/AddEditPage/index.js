        ...
        <div className="flex justify-between mt-3 mb-3">
          <PageHeader>
            ...
            {match && match.params && match.params.id
              ? 'Edit useful collection'
              : 'Add useful collection'}
          </PageHeader>
        </div>
        <PageContent>
          ...
          <div className="w-full md:w-1/2">
            ...
            />
            <div id="component-error-text">{errors.link}</div>
          </div>
...
const withReducer = injectReducer({ key: 'usefulCollection', reducer });
const withSaga = injectSaga({ key: 'usefulCollection', saga });
