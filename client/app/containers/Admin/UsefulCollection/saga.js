...
function* loadOne(action) {
  ...
  yield call(
    Api.get(
      `enum/useful_collections/${action.payload}`,
...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/useful-collection'));
}
...
function* deleteSuccessFunc(action) {
  const snackbarData = {
    message: action.payload.msg || 'useful_collections delete success',
    options: {
      variant: 'success',
    },
  };
...
export default function* usefulCollectionSaga() {
