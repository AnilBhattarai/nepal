...
const AddEdit = props => {
  ...
  const handleGoBack = () => {
    props.push('/admin/property-purpose');
  };
...
// const withReducer = injectReducer({ key: 'propertyPurpose', reducer });
// const withSaga = injectSaga({ key: 'propertyPurpose', saga });
