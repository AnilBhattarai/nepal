...
function* loadAll(action) {
  ...
  yield call(
    Api.get(
      `enum/property_status?${query}`, // "?" le error fhalna sakcha hai
...
function* loadOne(action) {
  ...
  yield call(
    Api.get(
      `enum/property_status/${action.payload}`,
...
function* redirectOnSuccess() {
  ...
  yield put(push('/admin/property-status'));
}
...
export default function* propertyStatusSaga() {
