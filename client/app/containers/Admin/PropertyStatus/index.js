...
const key = 'propertyStatus';

export const PropertyStatus = props => {
  const {
  ...
  const handleAdd = () => {
    clearOne();
    push('/admin/property-status/add');
  };

  const handleEdit = id => {
    push(`/admin/property-status/edit/${id}`);
  };
  ...
  return (
    <>
      <Helmet>
        <title>Property Status Manage</title>
      </Helmet>
      <DeleteDialog
        open={open}
        doClose={handleClose}
      ...
      <div className="flex justify-between mt-3 mb-3">
        ...
        <PageHeader>Property Status Manage </PageHeader>
        <Fab
          color="primary"
          aria-label="Add"
