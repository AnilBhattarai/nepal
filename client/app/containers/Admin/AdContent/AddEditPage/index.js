...
class AddEdit extends React.PureComponent {
  ...
  handleGoBack = () => {
    this.props.push('/admin/ad-manage');
  };
        ...
        <div>
          ...
          <PageContent>
              ...
              <div className="w-full md:w-1/2 -ml-2">
                <div margin="normal" className={classes.formControl}>
                  ...
                  <DatePicker
                    ...
                    value={
                      (one.publish_from &&
                        moment(one.publish_from).format('YYYY-MM-DD HH:mm')) ||
                      ''
                    }
              ...
              <div className="w-full md:w-1/2 -mr-2">
                <div margin="normal" className={classes.formControl}>
                  ...
                  <DatePicker
                    ...
                    value={
                      (one.publish_to &&
                        moment(one.publish_to).format('YYYY-MM-DD HH:mm')) ||
                      ''
                    }
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={one.is_ad || false}
                  onClick={this.handleCheckedChange('is_ad')}
                  value="is_ad"
                  color="primary"
                />
              }
...
const withReducer = injectReducer({ key: 'adContent', reducer });
const withSaga = injectSaga({ key: 'adContent', saga });
