...
export class ContentsListingPage extends React.Component {
  ...
  handleAdd = () => {
    this.props.clearOne();
    this.props.push('/admin/ad-manage/add');
  };

  handleEdit = id => {
    this.props.push(`/admin/ad-manage/edit/${id}`);
  };
    ...
    return (
      <>
        ...
        <div className="flex justify-between mt-3 mb-3">
          ...
          <PageHeader>Advertisements Manage</PageHeader>
          <Fab
            color="primary"
            aria-label="Add"
          ...
          <div className="flex">
            ...
            <div>
              <button
                ...
                className="px-4 py-1 text-secondary underline rounded ml-2"
