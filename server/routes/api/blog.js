...
const { authorization, authentication, byPassAuthorization } = require('../../middleware/authentication.middleware');
...
router.get('/html/:id', blogModule.GetBlogByIdHtml);
router.get('/feed', blogModule.GetRssFeedXML);
...
router.get('/blog/:slug_url', byPassAuthorization, blogModule.GetBlogBySlug);
